...
class StoreModel {
  ...
  factory StoreModel.fromJson(Map<String, dynamic> json) {
    ...
    // URL biasa, padahal ProductModel (yang fotonya sudah terbukti berhasil
    // tampil di halaman detail produk) memakai jalur berbeda:
    // _resolveImageUrl() lalu resolveImageUrlWithProxy() dari config.dart,
    // yang mengubah URL "/storage/..." menjadi URL proxy "/api/image/...".
    // Kalau proxy ini dilewati, foto gagal dimuat. Sekarang StoreModel
    // memakai jalur resolve yang SAMA PERSIS dengan ProductModel.
