  ...
  Widget _buildHeader(AuthProvider auth) {
    return Container(
      ...
      child: Row(children: [
        ...
        // Tombol ikon "Saldo & Pajak" di header sengaja TIDAK ada — akses ke
        // halaman Saldo & Pajak Platform tetap tersedia lewat tombol
        // "Tarik Saldo" / "Lihat Detail" di tab Keuangan.
