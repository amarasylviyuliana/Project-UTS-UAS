...
php -S https://bumdes-api-production.up.railway.app -t public
```
...
**Expected URLs:**
- Backend API: `https://bumdes-api-production.up.railway.app/api`
...
curl -i https://bumdes-api-production.up.railway.app/api/products
